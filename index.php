...
?>
    ...
    <section class="hero-2-bg position-relative d-flex align-items-center bg-gradient-primary" id="home">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="hero-2-title pr-lg-5">
                            <h1 class="hero-2-title text-white mb-4 font-weight-normal line-height-1_4">Explore, Rate, and Connect</h1>
                            <p class="text-white-70 font-weight-light f-18 line-height-1_6 mb-5 ">Join our community of reviewers and share your experiences. Together, we'll discover the best of everything!</p>
                            <a href="./login.php" class="btn btn-warning mr-lg-2"><i class="mdi mdi-link-variant mr-2"></i> Login</a>
        ...
        <div class="hero-bottom-img">
            <img src="images/hero-2-shape.png" alt="" class="img-fluid d-block w-100 mx-auto">
        </div>
    </section>
    <!-- Hero End -->
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    <div class="text-center text-muted">
                        <p class="mb-0 f-15">2020 © Hargeisa Guide.</p>
                    </div>
                </div>
            </div>
        </div>
